...
void main() {
  ...
  testWidgets('DataTablePlus set border width test',
      (WidgetTester tester) async {
    const List<DataColumnPlus> columns = <DataColumnPlus>[
      DataColumnPlus(label: Text('column1')),
      DataColumnPlus(label: Text('column2')),
    ];
  ...
  testWidgets('DataRow2 renders custom colors when pressed',
    ...
    Widget buildTable() {
      return DataTablePlus(columns: const <DataColumnPlus>[
        DataColumnPlus(
          label: Text('Column1'),
        ),
      ], rows: <DataRowPlus>[
        ...
        home: Material(
          child: AlertDialog(
            content: DataTablePlus(
              columns: const <DataColumnPlus>[
                DataColumnPlus(label: Text('Col1')),
              ],
              rows: const <DataRowPlus>[
