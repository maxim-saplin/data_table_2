...
void main() {
  group('DataTable2', () {
    ...
    testWidgets('empty widget is displayed when there\'s no data', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester, buildTable(empty: const Text('No data'), noData: true));
  ...
  group('PaginatedDataTable2', () {
    ...
    testWidgets('Overidden S, M, L column sizes are applied to header cells', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showPage: false, showGeneration: false, columns: smlColumns, overrideSizes: true));
    ...
    testWidgets('autoRowsToHeight WITH headers works fine', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showPage: false, showGeneration: false, showHeader: true, autoRowsToHeight: true));
    ...
    testWidgets('autoRowsToHeight WITH headers AND card works fine', (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester,
          buildPaginatedTable(
              showPage: false, showGeneration: false, showHeader: true, wrapInCard: true, autoRowsToHeight: true));
      ...
      await tester.pumpWidget(MaterialApp(
        home: Material(
            child: buildPaginatedTable(
                showPage: false, showGeneration: false, showPageSizeSelector: true, autoRowsToHeight: true)),
      ));
    ...
    testWidgets('scrollController scrolls to bottom', (WidgetTester tester) async {
      var sc = ScrollController();
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(scrollController: sc, showGeneration: false, showPage: false));
    ...
    testWidgets('hidePaginator hides paginator', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
          home: Material(
              child: buildPaginatedTable(
                  showPage: false, showGeneration: false, showPageSizeSelector: true, hidePaginator: true))));
    ...
    testWidgets('PaginatorController works', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
          home: Material(
              child: buildPaginatedTable(
                  showPage: false, showGeneration: false, showPageSizeSelector: true, controller: controller))));
  ...
  group('AsyncPaginatedDataTable2', () {
    ...
    testWidgets('Default S, M, L column sizes are applied to header cells', (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester, buildAsyncPaginatedTable(showPage: false, showGeneration: false, columns: smlColumns));
    ...
    testWidgets('Overidden S, M, L column sizes are applied to header cells', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester,
          buildAsyncPaginatedTable(showPage: false, showGeneration: false, columns: smlColumns, overrideSizes: true));
    ...
    testWidgets('autoRowsToHeight WITH headers works fine', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester,
          buildAsyncPaginatedTable(showPage: false, showGeneration: false, showHeader: true, autoRowsToHeight: true));
    ...
    testWidgets('scrollController scrolls to bottom', (WidgetTester tester) async {
      var sc = ScrollController();
      await wrapWidgetSetSurf(
          tester, buildAsyncPaginatedTable(scrollController: sc, showGeneration: false, showPage: false));
    ...
    testWidgets('Switching page shows loading spinner', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
          home: Material(
              child:
                  buildAsyncPaginatedTable(showGeneration: false, showPageSizeSelector: true, hidePaginator: false))));
...
Tripple<Size> _getColumnSizes(WidgetTester tester, bool header) {
  ...
  debugPrint('${s0.width} ${s1.width} ${s2.width} ${s3.width}');
