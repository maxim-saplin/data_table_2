...
main() async {
  ...
  group('PaginatedDataTable2 Borders', () {
    testWidgets('0 fixed rows, 0 fixed columns', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showPage: false, fixedTopRows: 0, fixedLeftColumns: 0, border: border), const Size(500, 300));
    ...
    testWidgets('0 fixed rows, 1 fixed column', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showPage: false, fixedTopRows: 0, fixedLeftColumns: 1, border: border), const Size(500, 300));
    ...
    testWidgets('1 fixed row, 0 fixed columns', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showPage: false, fixedTopRows: 1, fixedLeftColumns: 0, border: border), const Size(500, 300));
  ...
  group('PaginatedDataTable2 Fixed cols/rows out of range', () {
    testWidgets('Fixed columns equal to the number of columns', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(
          tester,
          buildPaginatedTable(fixedTopRows: 1, showPage: false, showCheckboxColumn: false, showGeneration: false, fixedLeftColumns: 3),
          const Size(500, 300));
    ...
    testWidgets('Fixed columns greater than number of columns', (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(fixedTopRows: 1, showPage: false, showGeneration: false, fixedLeftColumns: 4), const Size(500, 300));
    ...
    testWidgets('Fixed rows/columns greater than number of rows/columns', (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showPage: false, showGeneration: false, fixedTopRows: 12, fixedLeftColumns: 5), const Size(500, 800));
    ...
    testWidgets('Fixed rows/columns greater than number of rows/columns, no checkbox column', (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester,
          buildPaginatedTable(showPage: false, showCheckboxColumn: false, showGeneration: false, fixedTopRows: 12, fixedLeftColumns: 5),
          const Size(500, 800));
  ...
  group('PaginatedDataTable2 Scrolling', () {
    ...
    testWidgets('3 fixed rows, 1 fixed column, no minWidth, scroll to bottom, scroll views sync test', (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 3, fixedLeftColumns: 1), const Size(500, 300));
    ...
    testWidgets('3 fixed rows, 2 fixed columns, no minWidth, scroll to bottom (via fixed col item), scroll views sync test ',
        (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 3, fixedLeftColumns: 2), const Size(500, 300));

      _verifyDataTable2InitialState(tester);
      expect(_isVisibleInTable(find.text('Ice cream sandwich'), tester), isTrue);

      await tester
          .ensureVisible(find.text('KitKat')); // now this one is ont the fixed column which has separate scrollable/controller from the left item
      expect(_isVisibleInTable(find.text('KitKat'), tester), isTrue);
      expect(_isVisibleInTable(find.text('518'), tester), isTrue);
      expect(_isVisibleInTable(find.text('65'), tester), isTrue);
    ...
    testWidgets('0 fixed rows, 1 fixed column, no minWidth, scroll to bottom, scroll views sync test ', (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 0, fixedLeftColumns: 2), const Size(500, 300));
    ...
    testWidgets('0 fixed rows, 2 fixed columns, no minWidth, scroll to bottom (via fixed col item), scroll views sync test ',
        (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 0, fixedLeftColumns: 2), const Size(500, 300));
    ...
    testWidgets('3 fixed rows, 2 fixed columns, with minWidth, scroll to bottom (via fixed col item), scroll views sync test ',
        (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(
          tester,
      ...
      await tester
          .ensureVisible(find.text('KitKat')); // now this one is one the fixed column which has separate scrollable/controller from the left item
      expect(_isVisibleInTable(find.text('KitKat'), tester), isTrue);
      expect(_isVisibleInTable(find.text('518'), tester), isTrue);
    ...
    testWidgets('0 fixed rows, 0 fixed columns, with minWidth, scroll to right', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 0, fixedLeftColumns: 0, minWidth: 850), const Size(525, 300));
    ...
    testWidgets('0 fixed rows, 1 fixed column, with minWidth, scroll to right', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 0, fixedLeftColumns: 1, minWidth: 850), const Size(525, 300));
    ...
    testWidgets('0 fixed rows, 2 fixed columns, with minWidth, scroll to right', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 0, fixedLeftColumns: 2, minWidth: 850), const Size(525, 300));
    ...
    testWidgets('1 fixed row, 1 fixed column, with minWidth, scroll to right (via fixed row item), scroll views sync test',
        (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(
          tester,
    ...
    testWidgets('1 fixed row, 2 fixed columns, with minWidth, scroll to right (via fixed row item), scroll views sync test',
        (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(
          tester,
    ...
    testWidgets('3 fixed rows, 2 fixed columns, with minWidth, scroll to right (via fixed row item), scroll views sync test',
        (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester,
    ...
    testWidgets('1 fixed row, 0 fixed columns, with minWidth, scroll to bottom right', (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 1, fixedLeftColumns: 0, minWidth: 850), const Size(505, 300));
    ...
    testWidgets('2 fixed rows, 0 fixed columns, with minWidth, scroll to bottom right', (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 2, fixedLeftColumns: 0, minWidth: 850), const Size(505, 300));
    ...
    testWidgets('3 fixed rows, 0 fixed columns, with minWidth, scroll to bottom right', (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 3, fixedLeftColumns: 0, minWidth: 850), const Size(505, 300));
    ...
    testWidgets('1 fixed row, 1 fixed column, with minWidth, scroll to bottom right', (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 1, fixedLeftColumns: 1, minWidth: 850), const Size(505, 300));
    ...
    testWidgets('1 fixed row, 2 fixed columns, with minWidth, scroll to bottom right', (WidgetTester tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 1, fixedLeftColumns: 2, minWidth: 850), const Size(505, 300));
    ...
    testWidgets('2 fixed rows, 2 fixed columns, with minWidth, scroll to bottom right', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 2, fixedLeftColumns: 2, minWidth: 850), const Size(505, 300));
    ...
    testWidgets('3 fixed rows, 2 fixed columns, with minWidth, scroll to bottom right', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(tester,
          buildPaginatedTable(showGeneration: false, showPage: false, fixedTopRows: 3, fixedLeftColumns: 2, minWidth: 850), const Size(505, 300));
    ...
    testWidgets('3 fixed rows, 2 fixed columns, with minWidth, with scrollController, scroll to bottom', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(
          tester,
          buildPaginatedTable(
              showGeneration: false, showPage: false, fixedTopRows: 3, fixedLeftColumns: 2, minWidth: 850, scrollController: verticalSc),
          const Size(850, 300));
