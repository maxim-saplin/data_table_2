...
void main() {
  ...
  testWidgets(
    ...
    await wrapWidgetSetSurf(tester,
        buildTable(fixedTopRows: 3, fixedLeftColumns: 1), const Size(500, 300));
  ...
  testWidgets(
      ...
      (WidgetTester tester) async {
    await wrapWidgetSetSurf(tester,
        buildTable(fixedTopRows: 3, fixedLeftColumns: 2), const Size(500, 300));
  ...
  testWidgets(
      ...
      (WidgetTester tester) async {
    await wrapWidgetSetSurf(tester,
        buildTable(fixedTopRows: 0, fixedLeftColumns: 2), const Size(500, 300));
