...
class DataTable2MinHeightDemo extends StatefulWidget {
  const DataTable2MinHeightDemo({super.key});

  @override
  DataTable2MinHeightDemoState createState() => DataTable2MinHeightDemoState();
}

class DataTable2MinHeightDemoState extends State<DataTable2MinHeightDemo> {
  ...
  DataRow _getRow(int index, [Color? color]) {
    ...
    return DataRow2.byIndex(
      ...
      cells: [
        ...
        const DataCell(Text(
            'some dummy long long text that cannot be shown in a single row')),
        const DataCell(Text(
            'some dummy long long text that cannot be shown in a single row')),
        const DataCell(Text(
            'some dummy long long text that cannot be shown in a single row')),
