...
class DataTable2ScrollupDemo extends StatefulWidget {
  const DataTable2ScrollupDemo({Key? key}) : super(key: key);
          ...
          Theme(
              ...
              data: ThemeData(
                  scrollbarTheme: ScrollbarThemeData(
                      isAlwaysShown: true, thumbColor: MaterialStateProperty.all<Color>(Colors.black))),
              child: DataTable2(
...
class _ScrollUpButton extends StatefulWidget {
  const _ScrollUpButton(this.controller, {Key? key}) : super(key: key);
    ...
    return _showScrollUp
        ? Positioned(
            ...
            child: OutlinedButton(
              ...
              onPressed: () =>
                  widget.controller.animateTo(0, duration: const Duration(milliseconds: 300), curve: Curves.easeIn),
              style: ButtonStyle(
