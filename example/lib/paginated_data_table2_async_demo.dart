...
import 'package:example/data/data_sources/async_dessert_data_source.dart';
import 'package:example/data/models/dessert.dart';
import 'package:example/isEmptyArg.dart';
import 'package:flutter/material.dart';

class PaginatedDataTable2AsyncDemo extends StatefulWidget {
  const PaginatedDataTable2AsyncDemo();

  @override
  _PaginatedDataTable2AsyncDemoState createState() =>
      _PaginatedDataTable2AsyncDemoState();
}

class _PaginatedDataTable2AsyncDemoState
    extends State<PaginatedDataTable2AsyncDemo> {
  int _rowIndex = 0;
  ...
  Widget build(BuildContext context) {
    return PaginatedDataTable2Async(
      horizontalMargin: 20,
