...
class DataTable2 extends DataTable {
  ...
  Widget _buildDataCell(
    ...
    final TextStyle effectiveDataTextStyle = dataTextStyle ?? themeData.dataTableTheme.dataTextStyle ?? themeData.textTheme.bodyMedium!;
    final double effectiveDataRowHeight = specificRowHeight ?? defaultDataRowHeight;
  ...
  Widget _addSecondaryTaps(GestureTapCallback? onRowSecondaryTap, GestureTapDownCallback? onRowSecondaryTapDown, Widget label) {
    if (onRowSecondaryTap != null || onRowSecondaryTapDown != null) {
      label = GestureDetector(onSecondaryTap: onRowSecondaryTap, onSecondaryTapDown: onRowSecondaryTapDown, child: label);
    }
    return label;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final double defaultDataRowHeight = dataRowHeight ?? theme.dataTableTheme.dataRowHeight ?? kMinInteractiveDimension;
    ...
    List<TableRow>? fixedColumnsRows = rows.isEmpty
        ...
        : actualFixedColumns > 0
            ? (actualFixedRows < 1
                ? [
                    _buildHeadingRow(context, theme,
                        fixedColumnsColor != null ? MaterialStatePropertyAll(fixedColumnsColor) : effectiveHeadingRowColor, actualFixedColumns),
                    ..._buildTableRows(
                        anyRowSelectable,
                ...
                : _buildTableRows(anyRowSelectable, fixedColumnsColor != null ? MaterialStatePropertyAll(fixedColumnsColor) : effectiveDataRowColor,
                    context, theme, actualFixedColumns, defaultRowColor, null, actualFixedRows - 1, 0, true))
            : null;
    ...
    List<TableRow>? fixedCornerRows = actualFixedColumns > 0 && actualFixedRows > 0
        ? (actualFixedRows == 1
            ? [
                _buildHeadingRow(context, theme, fixedCornerColor != null ? MaterialStatePropertyAll(fixedCornerColor) : effectiveHeadingRowColor,
                    actualFixedColumns)
              ]
            : [
                _buildHeadingRow(context, theme, fixedCornerColor != null ? MaterialStatePropertyAll(fixedCornerColor) : effectiveHeadingRowColor,
                    actualFixedColumns),
                ..._buildTableRows(anyRowSelectable, fixedCornerColor != null ? MaterialStatePropertyAll(fixedCornerColor) : effectiveDataRowColor,
                    context, theme, actualFixedColumns, defaultRowColor, null, 0, actualFixedRows - 1, true)
              ])
        : null;
  ...
  List<double> _calculateDataColumnSizes(BoxConstraints constraints, double checkBoxWidth, double effectiveHorizontalMargin) {
    ...
    var totalFixedWidth = columns.fold<double>(
        0.0, (previousValue, element) => previousValue + (element is DataColumn2 && element.fixedWidth != null ? element.fixedWidth! : 0.0));
    ...
    if (widths.length == 1) {
      widths[0] =
          math.max(0, widths[0] + effectiveHorizontalMargin + (checkBoxWidth > 0 ? effectiveHorizontalMargin / 2 : effectiveHorizontalMargin));
  ...
  List<TableRow> _buildTableRows(bool anyRowSelectable, MaterialStateProperty<Color?>? effectiveDataRowColor, BuildContext context, ThemeData theme,
      int numberOfCols, MaterialStateProperty<Color?> defaultRowColor, TableRow? headingRow,
      ...
      (int index) {
        ...
        if (headingRow != null && index == 0) {
          ...
          final Color? resolvedDataRowColor =
              (forceEffectiveDataRowColor ? effectiveDataRowColor : (rows[rowStartIndex + actualIndex].color ?? effectiveDataRowColor))
                  ?.resolve(states);
...
class SyncedScrollControllersState extends State<SyncedScrollControllers> {
  ...
  void _initControllers() {
    ...
    var verticalOffset = _sc11 == null || _sc11!.positions.isEmpty ? 0.0 : _sc11!.offset;
    ...
    _sc12 = ScrollController(initialScrollOffset: widget.sc12toSc11Position ? verticalOffset : 0.0);
